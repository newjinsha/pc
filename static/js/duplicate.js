    ...
    $.fn.DuplicateWindow = function () {
        ...
        function TestIfDuplicate() {
            ...
            if(tabObj === null){
                ...
                sessionStorage.setItem(sessionGuid, timeNow);
                return false;
            }
            else{
                sessionStorage.setItem(sessionGuid, timeNow);
                if(sessionGuid != tabObj.guid){
                    return true;
                }
                else{
                    return false;
            ...
            // if(sessionStorage.getItem(tabObj.guid) > tabObj.timestamp){
        ...
        $(window).on("beforeunload", function () {
            ...
            // else{
            //     removeCookie(localStorageTabKey);
            // }
        })
    }
